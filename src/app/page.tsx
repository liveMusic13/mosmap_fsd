...
export default async function Home({
	...
	return (
		// <div className='flex flex-col gap-2 min-h-0 min-w-0 flex-1 px-2.5 sm:px-4 2xl:px-15 py-2.5 2xl:py-10'>
		<div className='flex flex-col gap-2 min-h-0 min-w-0 flex-1 px-2.5 sm:px-4 py-2.5 '>
