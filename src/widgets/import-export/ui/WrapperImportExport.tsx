...
const WrapperImportExport: FC<IProps> = ({ title, children }) => {
	const router = useRouter();

	const handleBack = () => router.back();

	return (
		<div className='flex flex-col shadow-custom-green border border-border-gray rounded-xl max-h-full min-h-0 p-4 min-w-sm max-w-2xl'>
...
export default WrapperImportExport;
