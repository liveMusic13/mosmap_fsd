...
// const Footer: FC = () => {
// 	return (
// 		<footer className='h-auto sm:h-17 md:h-18 lg:h-21 xl:h-22 w-full bg-primary px-2.5 sm:px-5 md:px-7.5 xl:px-15 py-2'>
// 			<VStack>
// 				<div className='flex flex-col gap-4 sm:gap-0 sm:flex-row items-start sm:items-center justify-between w-full pb-1.5'>
...
// 						</h2>
// 					</HStack>
// 					<div className='flex flex-col sm:flex-row sm:flex-wrap justify-between items-start sm:items-center gap-1 sm:gap-5 md:gap-6 '>
...
const Footer: FC = () => {
	...
	return (
		<footer className='w-full bg-primary px-2.5 sm:px-5 md:px-7.5 xl:px-15 py-2 sm:h-17 md:h-18 lg:h-21 xl:h-22'>
			<VStack>
